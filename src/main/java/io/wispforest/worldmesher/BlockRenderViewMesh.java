...
public class BlockRenderViewMesh {

    protected final BlockRenderView world;
    protected final BlockPos origin;
    protected final BlockPos end;
    protected final boolean cull;
    protected final Box dimensions;

    private MeshState state = MeshState.NEW;
    private float buildProgress = 0;

    protected final Map<RenderLayer, VertexBuffer> bufferStorage;
    protected final Map<RenderLayer, BufferBuilder> initializedLayers;

    protected DynamicRenderInfo renderInfo;
    protected boolean freezeEntities;
    private boolean entitiesFrozen;

    protected final Runnable renderStartAction;
    protected final Runnable renderEndAction;

    private Supplier<MatrixStack> matrixStackSupplier = MatrixStack::new;

    public BlockRenderViewMesh(BlockRenderView world, BlockPos origin, BlockPos end, boolean cull, boolean freezeEntities, Runnable renderStartAction, Runnable renderEndAction) {
        this.world = world;
        this.origin = origin;
        this.end = end;
        this.cull = cull;
    ...
    public static class Builder {
        ...
        public BlockRenderViewMesh build() {
            ...
            return new BlockRenderViewMesh(world, start, target, cull, freezeEntities, startAction, endAction);
        }
    }
}
